...
void setup()
{
    ...
    // Pin mode for Input: temperatura
    //pinMode(0 , INPUT);
    // Pin mode for Input: humedad
    //pinMode(1 , INPUT);
    // Pin mode for Input: nivel_tanque
    //pinMode(2 , INPUT);
...
void loop()
{
    ...
    g_fisInput[1] = dht.readHumidity();
    // Read Input: nivel_tanque
    ...
    g_fisInput[2] = t/59;             //escalamos el tiempo a una distancia en cm
    ...
    Serial.print(g_fisInput[2]);      //Enviamos serialmente el valor de la distancia
    Serial.print("cm \n");
    //Serial.println();
...
int fis_gIMFCount[] = { 3, 3, 2 };

// Count of member function for each Output 
int fis_gOMFCount[] = { 3 };

// Coefficients for the Input Member Functions
FIS_TYPE fis_gMFI0Coeff1[] = { -40, -40, 10, 20 };
FIS_TYPE fis_gMFI0Coeff2[] = { 10, 25, 40 };
FIS_TYPE fis_gMFI0Coeff3[] = { 30, 40, 80, 80 };
FIS_TYPE* fis_gMFI0Coeff[] = { fis_gMFI0Coeff1, fis_gMFI0Coeff2, fis_gMFI0Coeff3 };
FIS_TYPE fis_gMFI1Coeff1[] = { 0, 0, 20, 40 };
FIS_TYPE fis_gMFI1Coeff2[] = { 30, 55, 80 };
FIS_TYPE fis_gMFI1Coeff3[] = { 70, 90, 100, 100 };
FIS_TYPE* fis_gMFI1Coeff[] = { fis_gMFI1Coeff1, fis_gMFI1Coeff2, fis_gMFI1Coeff3 };
FIS_TYPE fis_gMFI2Coeff1[] = { 0, 0, 10, 12 };
FIS_TYPE fis_gMFI2Coeff2[] = { 10, 12, 14, 14 };
...
FIS_TYPE fis_gMFO0Coeff1[] = { 0, 0, 1, 2 };
FIS_TYPE fis_gMFO0Coeff2[] = { 0, 2, 100, 120 };
FIS_TYPE fis_gMFO0Coeff3[] = { 90, 110, 255, 255 };
...
// Input range Min
FIS_TYPE fis_gIMin[] = { -40, 0, 0 };

// Input range Max
FIS_TYPE fis_gIMax[] = { 80, 100, 14 };
